...
namespace Punto_4
{
    ...
    class material
    {
        ...
        public material(string m)
        {
            ...
            Console.WriteLine("Este proceso pertenece a la clase material ");
        }
    ...
    class herramienta : material
    {
        ...
        public herramienta(string m , string fp) : base(m) 
        {
            funcionPrincipal = fp;
            Console.WriteLine (funcionPrincipal);
            Console.WriteLine("Este proceso pertenece a la clase herramienta");
        }
    ...
    internal class Martillo : herramienta {
        ...
        public Martillo(string m, string fp, double pg) : base (m , fp)
        {
            Pesogramos = pg;
            Console.WriteLine(Pesogramos);
            Console.WriteLine("Este proceso pertenece a la clase martillo");
        ...
        static void Main(string[] args)
        {
            ...
            Martillo martillo = new Martillo("madera", "Golpear clavos y pernos", 200.34);
